...
module.exports = new Promise(function(resolve, reject){
   ...
   // из полученных данных создаю массив с html блоками
    const item = data.results.map((elem, index) => {
       return (
        `
        <div class="filmsItem item nav-item" data-nav_ud="#premiere0,0,#channelBtn_inner,0">
        <div class="filmsItemBg" id="film${index}" style="background: url('${elem.info.poster}'); background-repeat:no-repeat;background-cover: cover;background-size: 100% 100%;" >
        </div>
